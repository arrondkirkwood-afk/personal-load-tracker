...
const APP_FILES = [
  ...
  './repair.html',
  './manifest.json',
  './manifest.json?v=1.22.0',
  './style.css',
  './style.css?v=1.22.0',
  './redesign.css',
  './redesign.css?v=1.22.0',
  './records-reports-redesign.css',
  './records-reports-redesign.css?v=1.22.0',
  './settings-redesign.css',
  './settings-redesign.css?v=1.22.0',
  './workbook-builder.css',
  './workbook-builder.css?v=1.22.0',
  './timesheet.css',
  './timesheet.css?v=1.22.0',
  './app-enhancements.css',
  './app-enhancements.css?v=1.22.0',
  './script.js',
  './script.js?v=1.22.0',
  './export-cleanup.js',
  './export-cleanup.js?v=1.22.0',
  './professional-export.js',
  './professional-export.js?v=1.22.0',
  './complete-workbook-export.js',
  './complete-workbook-export.js?v=1.22.0',
  './export-integration.js',
  './export-integration.js?v=1.22.0',
  './timesheet.js',
  './timesheet.js?v=1.22.0',
  './daily-closeout.js',
  './daily-closeout.js?v=1.22.0',
  './paycheck-reconciliation.js',
  './paycheck-reconciliation.js?v=1.22.0',
  './vendor/exceljs.min.js',
  './vendor/exceljs.min.js?v=1.22.0',
