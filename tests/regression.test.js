...
assert.ok(repairHtml.includes('index.html?v=1.13.0'), 'repair page opens the current version');
...
assert.strictEqual(appVersionMatch[1], '1.13.0', 'app version is updated');
