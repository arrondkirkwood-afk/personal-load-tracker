...
assert.ok(repairHtml.includes('index.html?v=1.18.0'), 'repair page opens the current version');
...
assert.strictEqual(appVersionMatch[1], '1.18.0', 'app version is updated');
...
assert.ok(html.includes('vendor/exceljs.min.js?v=1.18.0'), 'versioned Excel workbook library loads before the app');
