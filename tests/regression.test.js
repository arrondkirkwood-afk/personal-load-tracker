...
assert.ok(repairHtml.includes('index.html?v=1.11.3'), 'repair page opens the current version');
...
assert.strictEqual(appVersionMatch[1], '1.11.3', 'app version is updated');
