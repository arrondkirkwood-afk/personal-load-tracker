...
Saved loads, daily add-ons, daily earnings records, the driver/equipment profile, and app metadata are stored in the browser on the device you use. After signing in and completing the migration, Firestore becomes the synchronized source while local browser storage remains as a safety fallback.
...
Current app version and cache version: `1.2.1`, cache name `personal-oilfield-load-tracker-v1.2.1`.
